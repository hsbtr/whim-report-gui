  ...
  <low-code>
    <n-layout>
      ...
      <n-layout-content class="editor-content">
        ...
        <painting-area class="draw-inner" />
      </n-layout-content>
    </n-layout>
  </low-code>
</template>
...
.low-code {
  width: 100%;
  height: 100vh;
  background-color: v-bind('themes.baseColor');
  .low-code-header {
    width: 100%;
    height: 6.97vh;
    padding: 0 16px;
    margin: 0 0 16px 0;
    background-color: v-bind('themes.cardColor');
    border-bottom: solid 1px v-bind('themes.borderColor');
  ...
  .low-code-main {
    ...
    .sten-cli-box {
      flex: 0 0 300px;
      background-color: v-bind('themes.cardColor');
      border: solid 1px v-bind('themes.borderColor');
    }
    .paint-draw {
      flex: 1 1 auto;
      margin: 0 16px;
